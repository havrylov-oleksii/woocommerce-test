...
function wc_setup_product_data($post)
{
    ...
    if (empty($post->post_type) || !in_array($post->post_type, array('product', 'product_variation'))) return;
...
if (!function_exists('woocommerce_reset_loop')) {
    ...
    {
        $GLOBALS['woocommerce_loop'] = array('loop' => '', 'columns' => '', 'name' => '',);
    }
}
...
if (!function_exists('woocommerce_page_title')) {
    ...
    function woocommerce_page_title($echo = true)
    {
        ...
        if (is_search()) {
            ...
            if (get_query_var('paged')) $page_title .= sprintf(__('&nbsp;&ndash; Page %s', 'woocommerce'), get_query_var('paged'));
...
if (!function_exists('woocommerce_product_loop_start')) {
    ...
    function woocommerce_product_loop_start($echo = true)
    {
        ...
        if ($echo) echo ob_get_clean(); else
            return ob_get_clean();
    }
}
...
if (!function_exists('woocommerce_template_loop_add_to_cart')) {
    ...
    function woocommerce_template_loop_add_to_cart($args = array())
    {
        ...
        if ($product) {
            $defaults = array('quantity' => 1, 'class' => implode(' ', array_filter(array('button', 'product_type_' . $product->get_type(), $product->is_purchasable() && $product->is_in_stock() ? 'add_to_cart_button' : '', $product->supports('ajax_add_to_cart') ? 'ajax_add_to_cart' : '',))),);
...
if (!function_exists('woocommerce_grouped_add_to_cart')) {
    ...
    function woocommerce_grouped_add_to_cart()
    {
        ...
        if ($products) {
            ...
            wc_get_template('single-product/add-to-cart/grouped.php', array('grouped_product' => $product, 'grouped_products' => $products, 'quantites_required' => false,));
        }
    }
}
if (!function_exists('woocommerce_variable_add_to_cart')) {
    ...
    function woocommerce_variable_add_to_cart()
    {
        ...
        // Load the template
        wc_get_template('single-product/add-to-cart/variable.php', array('available_variations' => $get_variations ? $product->get_available_variations() : false, 'attributes' => $product->get_variation_attributes(), 'selected_attributes' => $product->get_default_attributes(),));
    }
}
if (!function_exists('woocommerce_external_add_to_cart')) {
    ...
    function woocommerce_external_add_to_cart()
    {
        ...
        wc_get_template('single-product/add-to-cart/external.php', array('product_url' => $product->add_to_cart_url(), 'button_text' => $product->single_add_to_cart_text(),));
    }
}
...
if (!function_exists('woocommerce_default_product_tabs')) {
    ...
    function woocommerce_default_product_tabs($tabs = array())
    {
        ...
        if ($product && ($product->has_attributes() || apply_filters('wc_product_enable_dimensions_display', $product->has_weight() || $product->has_dimensions()))) {
            $tabs['additional_information'] = array('title' => __('Additional information', 'woocommerce'), 'priority' => 20, 'callback' => 'woocommerce_product_additional_information_tab',);
        }

        // Reviews tab - shows comments
        if (comments_open()) {
            $tabs['reviews'] = array('title' => sprintf(__('Reviews (%d)', 'woocommerce'), $product->get_review_count()), 'priority' => 30, 'callback' => 'comments_template',);
        }
...
if (!function_exists('woocommerce_upsell_display')) {
    ...
    function woocommerce_upsell_display($limit = '-1', $columns = 4, $orderby = 'rand', $order = 'desc')
    {
        ...
        $args = apply_filters('woocommerce_upsell_display_args', array('posts_per_page' => $limit, 'orderby' => $orderby, 'columns' => $columns,));
        ...
        wc_get_template('single-product/up-sells.php', array('upsells'        => $upsells,

            // Not used now, but used in previous version of up-sells.php.
                                                             'posts_per_page' => $limit, 'orderby' => $orderby, 'columns' => $columns,));
    }
}
...
if (!function_exists('woocommerce_cross_sell_display')) {
    ...
    function woocommerce_cross_sell_display($limit = 2, $columns = 2, $orderby = 'rand', $order = 'desc')
    {
        ...
        wc_get_template('cart/cross-sells.php', array('cross_sells'    => $cross_sells,
...
if (!function_exists('woocommerce_login_form')) {
    ...
    function woocommerce_login_form($args = array())
    {
        ...
        $defaults = array('message' => '', 'redirect' => '', 'hidden' => false,);
...
if (!function_exists('woocommerce_checkout_payment')) {
    ...
    function woocommerce_checkout_payment()
    {
        ...
        wc_get_template('checkout/payment.php', array('checkout' => WC()->checkout(), 'available_gateways' => $available_gateways, 'order_button_text' => apply_filters('woocommerce_order_button_text', __('Place order', 'woocommerce')),));
    }
}
...
if (!function_exists('woocommerce_form_field')) {
    ...
    {
        $defaults = array('type' => 'text', 'label' => '', 'description' => '', 'placeholder' => '', 'maxlength' => false, 'required' => false, 'autocomplete' => false, 'id' => $key, 'class' => array(), 'label_class' => array(), 'input_class' => array(), 'return' => false, 'options' => array(), 'custom_attributes' => array(), 'validate' => array(), 'default' => '', 'autofocus' => '', 'priority' => '',);
...
if (!function_exists('get_product_search_form')) {
    ...
    function get_product_search_form($echo = true)
    {
        ...
        wc_get_template('product-searchform.php', array('index' => $product_search_form_index++,));
...
if (!function_exists('wc_display_item_meta')) {
    ...
    function wc_display_item_meta($item, $args = array())
    {
        $strings = array();
        $html = '';
        $args = wp_parse_args($args, array('before' => '<ul class="wc-item-meta"><li>', 'after' => '</li></ul>', 'separator' => '</li><li>', 'echo' => true, 'autop' => false,));
...
if (!function_exists('wc_display_item_downloads')) {
    ...
    function wc_display_item_downloads($item, $args = array())
    {
        $strings = array();
        $html = '';
        $args = wp_parse_args($args, array('before' => '<ul class ="wc-item-downloads"><li>', 'after' => '</li></ul>', 'separator' => '</li><li>', 'echo' => true, 'show_url' => false,));
