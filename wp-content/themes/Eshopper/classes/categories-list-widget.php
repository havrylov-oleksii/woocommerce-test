...
class Categories_List extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 'categories_list',
			...
			<?php foreach ( $product_cats_list as $cat ): ?>
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <h4>
							<?php $plus = ( ! empty( $brands ) ) ? '<span class="badge pull-right"><i class="fa fa-plus toggle" data-slug="' . $cat->slug . '"></i></span>' : ''; ?>
                            <a href="<?php echo get_term_link( $cat->term_id ); ?>" class="cat-link">
								<?php echo $plus; ?>
								<?php echo $cat->name; ?>
                            </a>
                        </h4>
                            ...
                            <div class="panel-body">
                                <ul>
									<?php foreach ( $brands as $brand ) : ?>
                                        <li><a data-cat="<?php echo $cat->slug; ?>"
                                               data-brand="<?php echo $brand->slug; ?>"
                                               class="js-filter"><?php echo $brand->name; ?></a>
                                        </li>
									<?php endforeach; ?>
                                </ul>
                            </div>
