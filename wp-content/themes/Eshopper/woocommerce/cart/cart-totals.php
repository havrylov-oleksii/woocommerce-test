...
?>
<div class="col-sm-6">
    <div class="total_area <?php if (WC()->customer->has_calculated_shipping()) echo 'calculated_shipping'; ?>">
        ...
        <input type="submit" class="btn btn-default update" name="update_cart"
